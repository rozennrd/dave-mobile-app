package com.example.dave.ui.theme
...
val SulphurPoint: FontFamily by lazy {
    FontFamily(
...
val Jost: FontFamily by lazy {
    FontFamily(
        Font(R.font.jost_variable_font_wght, FontWeight.Normal),
        Font(
            R.font.jost_italic_variable_font_wght,
            FontWeight.Normal,
            FontStyle.Italic
        ),
